...
var (
	...
	HttpRequestsTotal = prometheus.NewCounterVec(
		prometheus.CounterOpts{
			...
			Help: "Total number of HTTP requests processed.(评论服务请求总量)",
		},
		[]string{"method", "path"},
	)
	...
	HttpRequestDuration = prometheus.NewHistogramVec(
		prometheus.HistogramOpts{
			Name:    "comment_service_http_request_duration_milliseconds",
			Help:    "Histogram of response latency (seconds) of HTTP requests.(评论服务响应耗时ms)",
	...
	HttpRequestsErrors = prometheus.NewCounterVec(
		prometheus.CounterOpts{
			Name: "comment_service_errors_total.(评论服务错误总数)",
